...
mod tests{
    ...
    use crate::game_manager::{bot2::Bot2, bot::{Bot, GetMoveResult}, board2::BoardState, state_bitboard::{BoardStateNumbers, BitBoardState, bit_boards}, bot2_2::Bot2_2, move_string::{lan_move, move_string_short}, bot2_3::Bot2_3, bot2_4::Bot2_4, bot2_6::Bot2_6};
    ...
    fn bot_bench(){
        ...
        for fen in fens{
                let mut bot2 = Bot2_6::new(7, 18, 1000000, None);
